...
export const adminProducts = [
  ...
  { id: "shorts-blocker-kids", label: "Сайт Shorts Blocker Kids", href: "/admin/shorts-blocker-kids", status: "partial" },
] as const;

export function adminProductDescription(id: string): string {
  if (id === "shorts-blocker-kids") return "Відвідувачі, відвідування, переглянуті сторінки, натискання та послідовність дій на сайті Shorts Blocker Kids.";
